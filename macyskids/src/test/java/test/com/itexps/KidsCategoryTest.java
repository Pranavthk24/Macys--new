...
public class KidsCategoryTest {
  ...
  @Test
  public void KidsCategoryTest() throws Exception {
    driver.get(baseUrl + "chrome://newtab/");
    driver.get("https://www.costco.com/");
    driver.findElement(By.linkText("Clothing, Luggage & Handbags")).click();
    driver.findElement(By.linkText("Clothing for Girls")).click();
    ...
    try {
      assertEquals(driver.findElement(By.xpath("//div[@id='category-name-header']/h1")).getText(), "Clothing for Girls");
    } catch (Error e) {
        System.out.println(e.toString());
    }
    driver.findElement(By.xpath("//img[@alt='Dresses for Girls']")).click();
    driver.close();
}
}
